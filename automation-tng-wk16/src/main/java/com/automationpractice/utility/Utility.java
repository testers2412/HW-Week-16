...
//*************************** Action Methods ***************************************//
    ...
    public void doSliderMovement(WebElement slider, int xAxis, int yAxis) {
        Actions moveSlider = new Actions(driver);
        moveSlider.dragAndDropBy(slider, xAxis, yAxis).build().perform();
    }
...
//************************** Waits Methods *********************************************//
    ...
    public static String takeScreenShot(String fileName) {
        String filePath = System.getProperty("user.dir") + "/test-output/html/"; // path where screenshot needs to be saved
    ...
    public void pmVerifyElements(By by,String expectedMessage, String displayMessage) {
